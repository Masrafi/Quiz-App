...
class BangladeshExam extends StatefulWidget {
  @override
  _BangladeshExamState createState() => _BangladeshExamState();
}

class _BangladeshExamState extends State<BangladeshExam> {
  var kLabelStyle =
